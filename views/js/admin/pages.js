...
module.exports = function (fastify, opts, next) {
    ...
    fastify.get('/create', (req, res) => {
        ...
        fs.mkdirSync(`pages/${path.dirname(name)}`, { recursive: true, force: true });
    ...
    fastify.get('/delete', (req, res) => {
        let page = decodeURI(req.query.path);
        console.log(page);
        if (page == 'home' || !page || !fs.existsSync(`./pages/${page}.md`)) return res.code(404).send({statusCode: 404}); // Soon
    ...
    fastify.get('', async (req, res) => {
        ...
        files.forEach((filePath) => {
            ...
            <div class="box">
                ...
                <span><a href="pages/modify?path=${purePath}">modify</a>${del} - ${getFormatTime(timestamp)}</span>
            </div>`;
        });
